...
- Understand the underlying JS in JSX - it really helps to understand core concepts when you diverge from raw HTML syntax.
- JSX is smart enough to handle an object of props if you share it as a spread operator such as {...props}
- Doing it this way, it's important to ensure the variable names match the name of the property such as `className` or `children`.
